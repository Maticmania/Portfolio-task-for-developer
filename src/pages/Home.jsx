...
const Home = () => {
  return (
    <div className=''>
    <div className='container bg-[#F5FCFF] mx-auto flex flex-col-reverse place-content-center xl:flex-row px-4 xl:px-16 pt-[80px] md:pt-0 md:space-y-16 xl:space-y-0 xl:pt-[120px] py-12' id='home'>
